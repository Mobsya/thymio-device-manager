...
private:
    ...
    void schedule_send_ping(std::chrono::steady_clock::duration delay = std::chrono::seconds(1));
    void schedule_nodes_health_check(std::chrono::steady_clock::duration delay = std::chrono::seconds(5));
