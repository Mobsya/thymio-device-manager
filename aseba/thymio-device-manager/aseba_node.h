...
private:
    ...
    void schedule_variables_update(std::chrono::steady_clock::duration delay = std::chrono::milliseconds(100));
    ...
    boost::asio::steady_timer m_variables_timer;
    ...
    boost::asio::steady_timer m_resend_timer;
